...
<html class="no-js" lang="en" >
	...
	<head>
		<title>Delphi, Indiana CDL Testing | CDL Testing Inc.</title>
	...
	<body>
			...
			<div class="page-title">
				<div class="row">
					<div class="small-12 large-6 column">
						<h1  class="animated flipInX">Delphi,IN</h1>
					</div>
					<div class="small-12 large-6 column">
						...
						<h4>Office Address</h4>
					 	<address> 
							<ul class="list-unstyled">
				                <li> <i class="icon-home"></i>CDL Testing Inc.<br>1544 W US 421<br>Delphi, IN 46923</li>
		...
		/* Add Your Company Name latitude and  longitude here.
			 ...
			 *  */
			var latitude = "40.569210";
			var longitude = "-86.659920";
			var details = "CDL Testing, Inc. - Delphi,IN, United States";
